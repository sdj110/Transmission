...
namespace UnityStandardAssets._2D
{
    ...
    public class PlatformerCharacter2D : MonoBehaviour
    {
        ...
        private bool m_AimDown = false;
        private bool m_AimStrong = false;
        ...
        public void Aim(bool aimUp, bool aimDown, bool aimStrong)
        {
            m_AimUp = aimUp;
            m_AimDown = aimDown;
            m_AimStrong = aimStrong;
            m_Anim.SetBool("AimUp", m_AimUp);
            m_Anim.SetBool("AimDown", m_AimDown);
            m_Anim.SetBool("AimStrong", m_AimStrong);
        }
        ...
        public void SetFiringAnimation(bool firing)
        {
            m_Firing = firing;
        }
